...
Alephium's token supply is capped at 1 billion. At Mainnet Launch (Nov. 8th, 2021), 140M tokens (14% of the hardcap) was minted with the genesis block. The remaining ALPH tokens will be mined over the next ~80 years. The initial 140M tokens are allocated as follows:
